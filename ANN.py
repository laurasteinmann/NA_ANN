...
def build_network(arc,drop_rate,LC,DG):
    ...
    if LC == True:
        ...
        model.add(LocallyConnected1D(1,5,strides=1,input_shape=(x_train.shape[1],1)))#Änderung 5 vorher 10 strides 1 vorher 7
        model.add(Flatten())
        start = 0
